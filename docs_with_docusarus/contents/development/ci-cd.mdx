...
You can monitor the status of all workflows at: [GitHub Actions Dashboard](https://github.com/<GitHub username>/<GitHub repo>/actions)

## Continuous Integration

[![CI](https://github.com/<GitHub username>/<GitHub repo>/actions/workflows/ci.yaml/badge.svg)](https://github.com/<GitHub username>/<GitHub repo>/actions/workflows/ci.yaml)
[![CI + E2E](https://github.com/<GitHub username>/<GitHub repo>/actions/workflows/ci_includes_e2e_test.yaml/badge.svg)](https://github.com/<GitHub username>/<GitHub repo>/actions/workflows/ci_includes_e2e_test.yaml)
...
[![Release](https://github.com/<GitHub username>/<GitHub repo>/actions/workflows/release.yml/badge.svg)](https://github.com/<GitHub username>/<GitHub repo>/actions/workflows/release.yml)
[![Release Validation](https://github.com/<GitHub username>/<GitHub repo>/actions/workflows/release-validate.yml/badge.svg)](https://github.com/<GitHub username>/<GitHub repo>/actions/workflows/release-validate.yml)
[![Release Staging](https://github.com/<GitHub username>/<GitHub repo>/actions/workflows/release-staging.yml/badge.svg)](https://github.com/<GitHub username>/<GitHub repo>/actions/workflows/release-staging.yml)
...
**Release Status:**
- Monitor [Release Workflow](https://github.com/<GitHub username>/<GitHub repo>/actions/workflows/release.yml)
- Check [Validation Results](https://github.com/<GitHub username>/<GitHub repo>/actions/workflows/release-validate.yml)
...
[![CD](https://github.com/<GitHub username>/<GitHub repo>/actions/workflows/cd.yaml/badge.svg)](https://github.com/<GitHub username>/<GitHub repo>/actions/workflows/cd.yaml)
...
[![documentation](https://github.com/<GitHub username>/<GitHub repo>/actions/workflows/documentation.yaml/badge.svg)](https://github.com/<GitHub username>/<GitHub repo>/actions/workflows/documentation.yaml)
...
[![Check ClickUp API Specification Changes](https://github.com/<GitHub username>/<GitHub repo>/actions/workflows/check-clickup-api-spec.yaml/badge.svg)](https://github.com/<GitHub username>/<GitHub repo>/actions/workflows/check-clickup-api-spec.yaml)

The `check-clickup-api-spec.yaml` workflow verifies the ClickUp API specification against the implementation.

### Docker CI

[![docker-ci](https://github.com/<GitHub username>/<GitHub repo>/actions/workflows/docker-ci.yml/badge.svg)](https://github.com/<GitHub username>/<GitHub repo>/actions/workflows/docker-ci.yml)

The `docker-ci.yml` workflow tests Docker image building and functionality.

### DockerHub README CI

[![dockerhub-readme-ci](https://github.com/<GitHub username>/<GitHub repo>/actions/workflows/dockerhub-readme-ci.yml/badge.svg)](https://github.com/<GitHub username>/<GitHub repo>/actions/workflows/dockerhub-readme-ci.yml)

The `dockerhub-readme-ci.yml` workflow updates the Docker Hub repository description.

### Documentation Auto-Approve & Auto-Merge

[![docs-automerge](https://github.com/<GitHub username>/<GitHub repo>/actions/workflows/docs-automerge.yml/badge.svg)](https://github.com/<GitHub username>/<GitHub repo>/actions/workflows/docs-automerge.yml)
...
- [Workflow Definitions](https://github.com/<GitHub username>/<GitHub repo>/tree/master/.github/workflows)
