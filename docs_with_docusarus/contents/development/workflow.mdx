...
This guide outlines the recommended workflow for contributing to the <This project name> project.
...
- Browse existing [GitHub Issues](https://github.com/<GitHub username>/<GitHub repo>/issues) to find something to work on
...
1. Go to the [<This project name> repository](https://github.com/<your GitHub username>/<your repo>)
...
git remote add upstream https://github.com/<GitHub username>/<GitHub repo>.git
...
- Ask questions in the [GitHub Discussions](https://github.com/<GitHub username>/<GitHub repo>/discussions)
