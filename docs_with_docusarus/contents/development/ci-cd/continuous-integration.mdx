...
This document covers the Continuous Integration (CI) workflows used to maintain code quality and ensure tests pass in the Python uv template project.
...
- Labels reports with the package name (`src`)
