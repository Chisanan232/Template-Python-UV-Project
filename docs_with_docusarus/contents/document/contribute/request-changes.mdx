...
1. **Check existing requests**: Search the [GitHub Issues](https://github.com/<GitHub username>/<GitHub repo>/issues) to see if someone has already suggested a similar feature.
...
Please submit feature requests through our [GitHub Issues](https://github.com/<GitHub username>/<GitHub repo>/issues) page using the "Feature Request" template.
