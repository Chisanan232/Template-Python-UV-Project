...
1. **Check existing issues**: Search the [GitHub Issues](https://github.com/<GitHub username>/<GitHub repo>/issues) to see if the bug has already been reported.
...
Please submit bug reports through our [GitHub Issues](https://github.com/<GitHub username>/<GitHub repo>/issues) page using the "Bug Report" template.
